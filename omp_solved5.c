...
/**********************************************************
* MODIFICATION:
* Switched the order of the 2 locks below.
* The problem is the last section is waiting for b
* provided by the next secion; the next section is 
* waiting for a from the last section. Since they have 
* two locks in the different order, they are just
* waiting on each other forever. Hence the runtime error.
***********************************************************/
